...
(function (angular, $, _) {
  ...
  function DatatableDirective(l10n, $timeout, $parse) {
    return {
      ...
      replace: true,
      transclude: true,
      templateUrl: 'static/js/scaffolding/directives/datatable/datatableDirective.html',
      scope: {
        filterable: '&',
        pageable: '&',
        sortable: '&',
      ...
      link: function ($scope, $element, $attrs) {
        ...
        $scope.query = $attrs.query === undefined ? undefined : $scope.query;
        ...
        $scope.$parent.$watchCollection($attrs.items, function (items) {
          ...
          $scope.itemsCount = $parse($attrs.itemsCount)($scope.$parent);
